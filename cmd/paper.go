...
All rights for the downloaded content belong to the appropriate persons/organizations`,
	RunE: func(cmd *cobra.Command, args []string) error {
		jar, err := ops.DownloadPaperMC(VERBOSE, VERSION, ops.ProjectPaper, float64(PAPERMC_BUILD_ID), PAPERMC_EXPERIMENTAL, PAPERMC_MOJANG_MAPPINGS)
		if err != nil {
			return err
		}
		...
		fmt.Println("saved paper server jar at", FILENAME)
